  ...
  'privacy-policy': [
    {
      ...
      points: [
        'Personal Information: Name and contact information (email, phone, address).',
        'Personal Information: Payment information (credit card details, billing address).',
        'Personal Information: Account credentials (username, password).',
        'Personal Information: Order history and preferences.',
        'Personal Information: Communication preferences.',
        'Automatically Collected Information: IP address and device information.',
        'Automatically Collected Information: Browser type and version.',
        'Automatically Collected Information: Pages visited and time spent on pages.',
        'Automatically Collected Information: Referring website addresses.',
        'Automatically Collected Information: Cookies and similar tracking technologies.',
      ],
    },
    {
    ...
    },
    {
      ...
      points: [
        ...
        'Service Providers: Third-party vendors who help us operate our business (payment processors, shipping companies, email services).',
    ...
    },
    {
      ...
      points: [
        ...
        'To exercise these rights, please contact us at Gigahivepvtltd@gmail.com',
      ],
    },
    {
